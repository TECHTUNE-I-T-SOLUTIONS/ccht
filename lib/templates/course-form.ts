...
export async function generateCourseFormPDF(data: {
  ...
  pdf.text('CROSS COLLEGE OF HEALTH TECHNOLOGY', pageWidth / 2, y, { align: 'center' })
  y += 15
  ...
  pdf.setFont('helvetica', 'normal')
  pdf.setTextColor(100, 100, 100)
  pdf.text('This document is officially generated by the Cross College of Health Technology portal.', pageWidth / 2, y, { align: 'center' })
  y += 10
