  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Access Analytics</h1>
          <p className="mt-1 text-sm text-muted-foreground">Access pattern analytics</p>
        </div>
      </div>

      <Card className="p-12 text-center">
        <LogIn className="mx-auto h-16 w-16 text-muted-foreground mb-4" />
        <h2 className="text-xl font-semibold mb-2">Access Analytics</h2>
